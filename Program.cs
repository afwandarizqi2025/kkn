...
namespace KKN_Nagrak_RT04
{
    class Program
    {
        ...
        {
            // Data Mahasiswa
            daftarTim.Add(new Mahasiswa("Ahmad Fauzi", "Ketua Kelompok", "S1 Teknik Sipil"));
            daftarTim.Add(new Mahasiswa("Siti Rahma", "Sekretaris", "S1 Administrasi Publik"));
            daftarTim.Add(new Mahasiswa("Rian Hidayat", "Bendahara", "S1 Akuntansi"));
